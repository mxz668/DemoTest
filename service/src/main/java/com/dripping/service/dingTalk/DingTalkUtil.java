package com.dripping.service.dingTalk;
...
public class DingTalkUtil {
    ...
    public static Logger logger = LoggerFactory.getLogger(DingTalkUtil.class);
...
//        System.out.println(execute.getBody());
        ...
        if (jsonObject.getInteger("errcode").equals(0)) {
            ...
            logger.warn("dingTalk根据手机号:{},获取userId异常：{}", mobile, execute.getBody());
            return "";
        }
    }
